    ...
    class SlotSettings
    {
        ...
        public function OffsetReels($reels)
        {
            for( $r = 1; $r <= 5; $r++ ) 
            {
                ...
                if( $reels['reel' . $r][0] == '-1' && $reels['reel' . $r][1] == '-1' && $reels['reel' . $r][2] != '-1' ) 
                {
                    $_obf_0D3F3B2C262B04130F36321F0A14252C5C261D2A252801 = $reels['rp'][$r - 1] - 2;
                    if( $_obf_0D3F3B2C262B04130F36321F0A14252C5C261D2A252801 < 0 ) 
                    {
                        $_obf_0D3F3B2C262B04130F36321F0A14252C5C261D2A252801 = count($this->{'reelStrip' . $r}) - 2;
                    }
                    $_obf_0D24361824382C3D252D182938090A2D25403927110632 = $reels['rp'][$r - 1] - 3;
                    if( $_obf_0D24361824382C3D252D182938090A2D25403927110632 < 0 ) 
                    {
                        $_obf_0D24361824382C3D252D182938090A2D25403927110632 = count($this->{'reelStrip' . $r}) - 3;
                    }
                    $reels['rp'][$r - 1] -= 2;
                    $reels['reel' . $r][1] = $this->{'reelStrip' . $r}[$_obf_0D3F3B2C262B04130F36321F0A14252C5C261D2A252801];
                    $reels['reel' . $r][0] = $this->{'reelStrip' . $r}[$_obf_0D24361824382C3D252D182938090A2D25403927110632];
                }
                if( $reels['reel' . $r][0] != '-1' && $reels['reel' . $r][1] == '-1' && $reels['reel' . $r][2] == '-1' ) 
                {
                ...
                if( $reels['reel' . $r][0] == '-1' && $reels['reel' . $r][1] == '-1' && $reels['reel' . $r][2] == '-1' ) 
                {
                    ...
                    $_obf_0D3609163C0D2F1C3F2B222230222E3F2F171A25382F01 = $reels['rp'][$r - 1] - 4;
                    if( $_obf_0D3609163C0D2F1C3F2B222230222E3F2F171A25382F01 < 0 ) 
                    {
                        $_obf_0D3609163C0D2F1C3F2B222230222E3F2F171A25382F01 = count($this->{'reelStrip' . $r}) - 4;
                    }
                    $reels['rp'][$r - 1] -= 3;
                    $reels['reel' . $r][2] = $this->{'reelStrip' . $r}[$_obf_0D3F3B2C262B04130F36321F0A14252C5C261D2A252801];
                    $reels['reel' . $r][1] = $this->{'reelStrip' . $r}[$_obf_0D24361824382C3D252D182938090A2D25403927110632];
                    $reels['reel' . $r][0] = $this->{'reelStrip' . $r}[$_obf_0D3609163C0D2F1C3F2B222230222E3F2F171A25382F01];
                }
                if( $reels['rp'][$r - 1] < 0 ) 
                {
                ...
                for( $j = 0; $j < count($this->SymbolGame); $j++ ) 
                {
                    ...
                    else
                    {
                        ...
                        if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                        {
                            ...
                            for( $_obf_0D161F0F1C15210D3924402706042F132D352828130C01 = 0; $_obf_0D161F0F1C15210D3924402706042F132D352828130C01 < 3; $_obf_0D161F0F1C15210D3924402706042F132D352828130C01++ ) 
                            {
                                if( $s[$_obf_0D161F0F1C15210D3924402706042F132D352828130C01] != 9 ) 
                                {
                                    $reelsOffset['reel' . ($_obf_0D161F0F1C15210D3924402706042F132D352828130C01 + 1)][$linesId[$k][$_obf_0D161F0F1C15210D3924402706042F132D352828130C01] - 1] = -1;
                                }
                            }
                            $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][3] * $betline * $mpl * $bonusMpl;
                            if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                            {
                                ...
                                $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "pos": "' . $k . '", "initialValue": { }, "initialValueMoney": { }, "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "hl": "' . $sp[0] . '' . $sp[1] . '' . $sp[2] . '00", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "multiplier": "' . $mpl . '" }';
                            }
                        }
                        if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                        {
                            ...
                            $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][4] * $betline * $mpl * $bonusMpl;
                            if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                            {
                                $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "pos": "' . $k . '", "initialValue": { }, "initialValueMoney": { }, "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "hl": "' . $sp[0] . '' . $sp[1] . '' . $sp[2] . '' . $sp[3] . '0", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "multiplier": "' . $mpl . '" }';
                            }
                        }
                        if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                        {
                            ...
                            $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][5] * $betline * $mpl * $bonusMpl;
                            if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                            {
                                $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "pos": "' . $k . '", "initialValue": { }, "initialValueMoney": { }, "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "hl": "' . $sp[0] . '' . $sp[1] . '' . $sp[2] . '' . $sp[3] . '' . $sp[4] . '", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "multiplier": "' . $mpl . '" }';
                            }
                        }
                    }
                }
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                $_obf_0D360F0E1F1A363935363D35280B0F3F053D272F233C11 = 3;
                $_obf_0D340F1A341017095B37324005163D02312C041E262632 = [
                    1, 
                    2, 
                    3, 
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = rand(0, count($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}) - 6);
                    }
                }
            }
            $reel = [
