...
namespace VanguardLTE\Games\SwampLand2MN
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            {
                $_obf_0D2424112D063C191211095C2E26220D1F2F380E403911 = ['8'];
                shuffle($_obf_0D2424112D063C191211095C2E26220D1F2F380E403911);
                $bsym = $_obf_0D2424112D063C191211095C2E26220D1F2F380E403911[0];
                ...
                ] as $index => $reelStrip ) 
                {
                    if( is_array($this->$reelStrip) && count($this->$reelStrip) > 0 ) 
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$index + 1] = $this->GetRandomScatterPos($this->$reelStrip, $bsym);
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, $bsym);
                    }
                    else
                    {
