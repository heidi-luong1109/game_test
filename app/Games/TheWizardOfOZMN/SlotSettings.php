...
namespace VanguardLTE\Games\TheWizardOfOZMN
{
    class SlotSettings
    {
        ...
        public function GetSymPositions($reels)
        {
            ...
            for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 7; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 >= 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32-- ) 
            {
            ...
            $_obf_0D2722011B2C34273F323035330D123F2706282E131932 = $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[7] + (32 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[6]) + (1024 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[5]) + (32768 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[4]) + (1048576 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[3]) + (33554432 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[2]) + (1073741824 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[1]) + (34359738368 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[0]);
        ...
        public function GetRandomScatterPos($rp)
        {
            ...
            for( $i = 0; $i < count($rp); $i++ ) 
            {
                ...
                {
                    array_push($_obf_0D27292617142A0F131C2A07024013320B242130093D01, $i - 6);
                    array_push($_obf_0D27292617142A0F131C2A07024013320B242130093D01, $i - 7);
                    array_push($_obf_0D27292617142A0F131C2A07024013320B242130093D01, $i - 8);
                }
            }
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' ) 
            {
                ...
                ] as $index => $reelStrip ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$index + 1] = mt_rand(0, count($this->$reelStrip) - 14);
                    }
                }
            }
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = rand(0, count($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}) - 14);
                    }
                }
            }
            $reel = [
