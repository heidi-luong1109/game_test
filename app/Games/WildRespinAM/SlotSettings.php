...
namespace VanguardLTE\Games\WildRespinAM
{
    class SlotSettings
    {
        ...
        {
            $_obf_0D120E281703282C1815181740251E2C3E192C2B193232 = rand(0, count($this->reelStrip1) - 1);
            $_obf_0D291B0B350D1D332D022A0A340E270A5B2333140D2A32 = rand(0, count($this->reelStrip2) - 1);
            $_obf_0D033E26250502082E123F121927063C3009271F360622 = rand(0, count($this->reelStrip3) - 1);
            $_obf_0D0C261E25240E3F1D040B2732242C081C2F3934013F11 = rand(0, count($this->reelStrip4) - 1);
            $_obf_0D1B01222B2E374007332B364016171517031D10382932 = rand(0, count($this->reelStrip5) - 1);
            return $this->HexFormat($_obf_0D120E281703282C1815181740251E2C3E192C2B193232) . $this->HexFormat($_obf_0D291B0B350D1D332D022A0A340E270A5B2333140D2A32) . $this->HexFormat($_obf_0D033E26250502082E123F121927063C3009271F360622) . $this->HexFormat($_obf_0D0C261E25240E3F1D040B2732242C081C2F3934013F11) . $this->HexFormat($_obf_0D1B01222B2E374007332B364016171517031D10382932);
        }
        ...
        {
            $game = $this->game;
            $_obf_0D372812180632030D09173F33293E3C2B161911231922 = rand(0, 7);
            ...
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    if( $i == 0 || $i == $rSym ) 
                    {
                        if( $i == 0 ) 
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, $_obf_0D372812180632030D09173F33293E3C2B161911231922, true);
                        }
                        else
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, '9', false);
                        }
                    }
                    else
                    {
            ...
            $reel = [
                'rp' => [], 
                'rsym' => $_obf_0D372812180632030D09173F33293E3C2B161911231922
            ];
