    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[1] = mt_rand(0, count($this->reelStrip1) - 3);
                $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[2] = $this->GetRandomScatterPos($this->reelStrip2);
                $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[3] = $this->GetRandomScatterPos($this->reelStrip3);
                $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[4] = $this->GetRandomScatterPos($this->reelStrip4);
                $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[5] = mt_rand(0, count($this->reelStrip5) - 3);
            }
            $reel = [
                'rp' => []
            ];
