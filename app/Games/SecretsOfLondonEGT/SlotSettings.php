...
namespace VanguardLTE\Games\SecretsOfLondonEGT
{
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            {
                $_obf_0D3D22130F23110D211A12043823130C1D1D090B253022 = ['11'];
                shuffle($_obf_0D3D22130F23110D211A12043823130C1D1D090B253022);
                if( $_obf_0D3D22130F23110D211A12043823130C1D1D090B253022[0] == '11' ) 
                {
                ...
                else
                {
                    ...
                    $_obf_0D2E231302321E2F343D3B3E320D03190C0A0923342F01 = 3;
                }
                for( $i = 0; $i < count($_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811[$_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]}, $_obf_0D3D22130F23110D211A12043823130C1D1D090B253022[0]);
                    }
                    else
                    {
