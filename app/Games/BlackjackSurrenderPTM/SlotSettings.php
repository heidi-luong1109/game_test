...
namespace VanguardLTE\Games\BlackjackSurrenderPTM
{
    class SlotSettings
    {
        ...
        public function GetThreeWin($cards)
        {
            ...
            $_obf_0D3E162F3430313C172F3F3C05240C213D092329010111 = 0;
            $_obf_0D123822023E012533162723355C17041A123112110C11 = 0;
            $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 0;
            $_obf_0D111E02401A331F1A2D15050E361E063C28143F3E3F11 = [
                $cards[0]->value, 
                $cards[1]->value, 
                $cards[2]->value
            ];
            sort($_obf_0D111E02401A331F1A2D15050E361E063C28143F3E3F11, SORT_NUMERIC);
            ...
            if( $_obf_0D111E02401A331F1A2D15050E361E063C28143F3E3F11[0] == ($_obf_0D111E02401A331F1A2D15050E361E063C28143F3E3F11[1] - 1) && $_obf_0D111E02401A331F1A2D15050E361E063C28143F3E3F11[0] == ($_obf_0D111E02401A331F1A2D15050E361E063C28143F3E3F11[2] - 2) ) 
            {
                $straight = 1;
            }
            ...
            if( $straight == 1 ) 
            {
                $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 11;
            }
            if( $_obf_0D123822023E012533162723355C17041A123112110C11 == 1 ) 
            {
                $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 31;
            }
            if( $_obf_0D0526242B1D1D5B5B1E1A23212E351B0C342207401C32 == 1 ) 
            {
                $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 41;
            }
            return $_obf_0D3930021E065C30212C110F1D2D150E03113925171401;
        }
        public function GetSideWin($cards)
        {
            $_obf_0D5C0423171007291F222416122A1C181C0C2E15260401 = 0;
            $_obf_0D0F1005373E2C09255B3D1C373F3C2F21261C2E120B32 = 0;
            $_obf_0D3211130E340D393403025C0F3D322526122A1C3E3501 = 0;
            $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 0;
            if( $cards[0]->value == $cards[1]->value ) 
            {
                ...
                {
                    $_obf_0D5C0423171007291F222416122A1C181C0C2E15260401 = 1;
                    $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 7;
                }
                if( $cards[0]->suit == $cards[1]->suit ) 
                {
                    $_obf_0D0F1005373E2C09255B3D1C373F3C2F21261C2E120B32 = 1;
                    $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 = 13;
                }
            }
            return $_obf_0D3930021E065C30212C110F1D2D150E03113925171401;
        }
        public function GetScore(&$box)
        {
            ...
            $box['altScore'] = 0;
            $box['state'] = '';
            $_obf_0D332D390B193C313202271A322C372B0A2E275B291C22 = [
                2, 
                3, 
                4, 
                5, 
            ...
            $_obf_0D2F2A0C2F343B210319023D15052B1C37373F09211E32 = [
                2, 
                3, 
                4, 
                5, 
            ...
            {
                $_obf_0D140B15352915010B3C0F073425122C3919262D140632 = $box['cards'][$i];
                $box['mainScore'] += $_obf_0D332D390B193C313202271A322C372B0A2E275B291C22[$_obf_0D140B15352915010B3C0F073425122C3919262D140632->value];
                $box['altScore'] += $_obf_0D2F2A0C2F343B210319023D15052B1C37373F09211E32[$_obf_0D140B15352915010B3C0F073425122C3919262D140632->value];
            }
        ...
        public function GetHistory()
        {
            ...
            foreach( $history as $log ) 
            {
                ...
                if( isset($_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent) && $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'gambleResult' && $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'jackpot' ) 
                {
        ...
        {
            $_obf_0D2904405C12281A2E2F311E3F38212D353E0418032C22 = [];
            foreach( $this->gameData as $key => $vl ) 
            {
                $pos = strpos($key, $this->slotId);
                if( $pos !== false ) 
                {
                    $_obf_0D2904405C12281A2E2F311E3F38212D353E0418032C22[$key] = $this->gameData[$key]['payload'];
                }
            }
            return json_encode($_obf_0D2904405C12281A2E2F311E3F38212D353E0418032C22);
        }
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            {
                $_obf_0D172C04372D1A2A3C2B33260B34083837222A08343211 = $this->slotId . ' SUR';
            }
            ...
            {
                $_obf_0D172C04372D1A2A3C2B33260B34083837222A08343211 = $this->slotId . ' INS';
            }
            $game = $this->game;
