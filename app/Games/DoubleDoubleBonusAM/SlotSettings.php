    ...
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits, $tipMode)
        {
            ...
            for( $i = 2; $i <= 14; $i++ ) 
            {
                ...
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 4 && $i == 14 && in_array($_obf_0D2E140C2712361F1F0F170E2C0C09400B3E283E161122[0], [
                    2, 
                    3, 
                    4
                ]) ) 
                {
                    ...
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[11]['cards'][0] = $i;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[11]['cards'][1] = $_obf_0D2E140C2712361F1F0F170E2C0C09400B3E283E161122[0];
                }
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 4 && in_array($i, [
                    2, 
                    3, 
                    4
                ]) && in_array($_obf_0D2E140C2712361F1F0F170E2C0C09400B3E283E161122[4], [14]) ) 
                {
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[10]['amount'] = 1;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[10]['cards'][0] = $i;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[10]['cards'][1] = $_obf_0D2E140C2712361F1F0F170E2C0C09400B3E283E161122[4];
                }
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 4 && in_array($i, [14]) ) 
                {
                ...
                ]) ) 
                {
                    ...
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['cards'][0] = $i;
                }
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 4 && in_array($i, [
                    5, 
                    6, 
