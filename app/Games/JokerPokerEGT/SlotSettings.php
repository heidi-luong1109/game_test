...
namespace VanguardLTE\Games\JokerPokerEGT
{
    class SlotSettings
    {
        ...
        {/*
            ...
            $this->Percent = $this->shop['currency'];
        ...
        {
            $_obf_0D370813382133162A37392A02130F102A0504373E0E11 = $cards;
            $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01 = $suits;
            sort($_obf_0D370813382133162A37392A02130F102A0504373E0E11, SORT_NUMERIC);
            sort($_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01, SORT_NUMERIC);
            $Paytable = [
                0, 
                1, 
                1, 
            ...
            $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32 = [
                0, 
                0, 
                0, 
                0, 
            ...
            for( $i = 2; $i <= 14; $i++ ) 
            {
                for( $j = 0; $j < 5; $j++ ) 
                {
                    if( $_obf_0D370813382133162A37392A02130F102A0504373E0E11[$j] == $i ) 
                    {
                        $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i]++;
                    }
                }
            }
            $_obf_0D083C233039093F360A29154027163C26071535091311 = [];
            $_obf_0D083C233039093F360A29154027163C26071535091311[0] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[1] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[2] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[3] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[4] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[5] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[6] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[7] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[8] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[9] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[10] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D083C233039093F360A29154027163C26071535091311[11] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            for( $i = 2; $i <= 14; $i++ ) 
            {
                if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 2 && $_obf_0D083C233039093F360A29154027163C26071535091311[1]['amount'] == 1 ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[2]['amount'] = 1;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[2]['cards'][0] = $i;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[2]['cards'][1] = $_obf_0D083C233039093F360A29154027163C26071535091311[1]['cards'][0];
                }
                else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 2 ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[1]['amount'] = 1;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[1]['cards'][0] = $i;
                }
                else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 3 ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[3]['amount'] = 1;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[3]['cards'][0] = $i;
                }
                else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 4 ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[7]['amount'] = 1;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[7]['cards'][0] = $i;
                }
                else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 1] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 2] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 3] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 4] == 1 ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[4]['amount'] = 1;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][0] = $i;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][1] = $i + 1;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][2] = $i + 2;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][3] = $i + 3;
                    $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][4] = $i + 4;
                }
            }
            if( $_obf_0D083C233039093F360A29154027163C26071535091311[1]['amount'] == 1 && $_obf_0D083C233039093F360A29154027163C26071535091311[3]['amount'] == 1 ) 
            {
                $_obf_0D083C233039093F360A29154027163C26071535091311[6]['amount'] = 1;
                $_obf_0D083C233039093F360A29154027163C26071535091311[6]['cards'][0] = $_obf_0D083C233039093F360A29154027163C26071535091311[1]['cards'][0];
                $_obf_0D083C233039093F360A29154027163C26071535091311[6]['cards'][1] = $_obf_0D083C233039093F360A29154027163C26071535091311[1]['cards'][1];
                $_obf_0D083C233039093F360A29154027163C26071535091311[6]['cards'][2] = $_obf_0D083C233039093F360A29154027163C26071535091311[3]['cards'][0];
                $_obf_0D083C233039093F360A29154027163C26071535091311[6]['cards'][3] = $_obf_0D083C233039093F360A29154027163C26071535091311[3]['cards'][1];
                $_obf_0D083C233039093F360A29154027163C26071535091311[6]['cards'][4] = $_obf_0D083C233039093F360A29154027163C26071535091311[3]['cards'][2];
            }
            if( $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[0] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[1] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[1] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[2] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[2] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[3] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[3] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[4] ) 
            {
                $_obf_0D083C233039093F360A29154027163C26071535091311[5]['amount'] = 1;
                $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'][0] = $cards[0];
                $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'][1] = $cards[1];
                $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'][2] = $cards[2];
                $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'][3] = $cards[3];
                $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'][4] = $cards[4];
            }
            if( $_obf_0D083C233039093F360A29154027163C26071535091311[5]['amount'] == 1 && $_obf_0D083C233039093F360A29154027163C26071535091311[4]['amount'] == 1 ) 
            {
                $_obf_0D083C233039093F360A29154027163C26071535091311[8]['amount'] = 1;
                $_obf_0D083C233039093F360A29154027163C26071535091311[8]['cards'] = $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'];
            }
            if( $_obf_0D083C233039093F360A29154027163C26071535091311[8]['amount'] == 1 && $_obf_0D083C233039093F360A29154027163C26071535091311[8]['cards'][4] == 14 ) 
            {
                $_obf_0D083C233039093F360A29154027163C26071535091311[11]['amount'] = 1;
                $_obf_0D083C233039093F360A29154027163C26071535091311[11]['cards'] = $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'];
            }
            $pay = 0;
            $holds = [
                0, 
            ...
            $_obf_0D2935172C2D3E33131C29291803132C14162A1D0F1B32 = 0;
            for( $i = count($_obf_0D083C233039093F360A29154027163C26071535091311) - 1; $i >= 1; $i-- ) 
            {
                if( $_obf_0D083C233039093F360A29154027163C26071535091311[$i]['amount'] == 1 && $_obf_0D083C233039093F360A29154027163C26071535091311[$i]['cards'][0] < 13 && $i == 1 ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[$i]['amount'] = 0;
                }
                if( $_obf_0D083C233039093F360A29154027163C26071535091311[$i]['amount'] == 1 ) 
                {
                    $pay = $Paytable[$i];
                    $_obf_0D2935172C2D3E33131C29291803132C14162A1D0F1B32 = $i;
                    break;
                }
            }
            $_obf_0D070D1D5C0934381D2119240E2D34342B3301022E0501 = $_obf_0D083C233039093F360A29154027163C26071535091311[$_obf_0D2935172C2D3E33131C29291803132C14162A1D0F1B32]['cards'];
            for( $i = 0; $i < 5; $i++ ) 
            {
                if( in_array($cards[$i], $_obf_0D070D1D5C0934381D2119240E2D34342B3301022E0501) ) 
                {
                    $holds[$i] = $cards[$i];
                }
            }
            if( $tipMode && $pay == 0 ) 
            {
                ...
                $_obf_0D230D0417131A2F102532351826092F2739040B133811 = 0;
                for( $i = 2; $i <= 14; $i++ ) 
                {
                    if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 1 && $i >= 13 ) 
                    {
                        $_obf_0D083C233039093F360A29154027163C26071535091311[1]['amount'] = 1;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[1]['cards'][$_obf_0D230D0417131A2F102532351826092F2739040B133811] = $i;
                        $_obf_0D230D0417131A2F102532351826092F2739040B133811++;
                    }
                    else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 2 && $i < 13 ) 
                    {
                        $_obf_0D083C233039093F360A29154027163C26071535091311[3]['amount'] = 1;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[3]['cards'][0] = $i;
                    }
                    else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 1] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 2] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 3] == 1 ) 
                    {
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['amount'] = 1;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][0] = $i;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][1] = $i + 1;
                    ...
                    else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 1] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 3] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 4] == 1 ) 
                    {
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['amount'] = 1;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][0] = $i;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][1] = $i + 1;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][2] = $i + 3;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][3] = $i + 4;
                    }
                    else if( $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 2] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 3] == 1 && $_obf_0D15060D155C2C2F3410152E371C295C13272B3D0C1E32[$i + 4] == 1 ) 
                    {
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['amount'] = 1;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][0] = $i;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][1] = $i + 2;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][2] = $i + 3;
                        $_obf_0D083C233039093F360A29154027163C26071535091311[4]['cards'][3] = $i + 4;
                    }
                }
                if( $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[0] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[1] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[1] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[2] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[2] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[3] ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[5]['amount'] = 1;
                    $_obf_0D241E31241F3F1A121909231A142F01402F0D2A5C0D32 = $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[0];
                    $_obf_0D0206171C130507273F0E2B38261F25083F3D073E1532 = 0;
                    for( $_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811 = 0; $_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811 < 5; $_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811++ ) 
                    {
                        if( $_obf_0D241E31241F3F1A121909231A142F01402F0D2A5C0D32 == $suits[$_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811] ) 
                        {
                            $_obf_0D083C233039093F360A29154027163C26071535091311[5]['cards'][$_obf_0D0206171C130507273F0E2B38261F25083F3D073E1532] = $cards[$_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811];
                            $_obf_0D0206171C130507273F0E2B38261F25083F3D073E1532++;
                        }
                    }
                }
                if( $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[1] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[2] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[2] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[3] && $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[3] == $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[4] ) 
                {
                    $_obf_0D083C233039093F360A29154027163C26071535091311[5]['amount'] = 1;
                    $_obf_0D241E31241F3F1A121909231A142F01402F0D2A5C0D32 = $_obf_0D322F312635253F0E010D070E223C0F2F321A162F0A01[1];
                    $_obf_0D0206171C130507273F0E2B38261F25083F3D073E1532 = 0;
                    for( $_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811 = 0; $_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811 < 5; $_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811++ ) 
                    {
                        if( $_obf_0D241E31241F3F1A121909231A142F01402F0D2A5C0D32 == $suits[$_obf_0D0C39080C042A22140A015C1F390B041E1A0E19310811] ) 
                ...
                $_obf_0D2638231F355B2912150F0A1C3C0631171D21152C1611 = 0;
                for( $i = count($_obf_0D083C233039093F360A29154027163C26071535091311) - 1; $i >= 1; $i-- ) 
                {
                    if( $_obf_0D083C233039093F360A29154027163C26071535091311[$i]['amount'] == 1 ) 
                    {
                        $_obf_0D2638231F355B2912150F0A1C3C0631171D21152C1611 = $i;
                        break;
                    }
                }
                $_obf_0D070D1D5C0934381D2119240E2D34342B3301022E0501 = $_obf_0D083C233039093F360A29154027163C26071535091311[$_obf_0D2638231F355B2912150F0A1C3C0631171D21152C1611]['cards'];
                for( $i = 0; $i < 5; $i++ ) 
                {
                    if( $_obf_0D083C233039093F360A29154027163C26071535091311[5]['amount'] == 1 ) 
                    {
                        if( $_obf_0D241E31241F3F1A121909231A142F01402F0D2A5C0D32 == $suits[$i] ) 
                        {
                            $holds[$i] = $cards[$i];
                        }
                    }
                    else if( in_array($cards[$i], $_obf_0D070D1D5C0934381D2119240E2D34342B3301022E0501) ) 
                    {
                        $holds[$i] = $cards[$i];
                    }
                }
            ...
            return [
                $pay, 
                $_obf_0D2935172C2D3E33131C29291803132C14162A1D0F1B32, 
                $holds
            ];
        }
