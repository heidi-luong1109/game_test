...
namespace VanguardLTE\Games\RingsOfFortuneGTM
{
    class SlotSettings
    {
        ...
        public function CalculateSpin($bet, $lines, $linesId, $cReels)
        {
            ...
            for( $_obf_0D190B192D351B14365C1F3235060F172B3C291D3C3411 = 0; $_obf_0D190B192D351B14365C1F3235060F172B3C291D3C3411 <= 5; $_obf_0D190B192D351B14365C1F3235060F172B3C291D3C3411++ ) 
            {
                $cWins = [
                    0, 
                    0, 
                ...
                for( $k = 0; $k < $lines; $k++ ) 
                {
                    for( $j = 0; $j < count($this->SymbolGame); $j++ ) 
                    {
                        ...
                        if( $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == $scatter || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_1' || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_2' || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_3' ) 
                        {
                        }
                        else
                        {
