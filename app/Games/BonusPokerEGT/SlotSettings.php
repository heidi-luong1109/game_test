...
namespace VanguardLTE\Games\BonusPokerEGT
{
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits)
        {
            ...
            $_obf_0D1B2E1D2408362306342211305C343014232A05252911 = 0;
            $_obf_0D402A190D1F240B2913211302273E06022932173C1F22 = 0;
            $_obf_0D5B0F052F10120C34130F05300E2E0C190E3D38233F01 = 0;
            $_obf_0D3929343302061507070B045B1B293918105C183F2901 = 0;
            ...
            for( $i = 2; $i <= 14; $i++ ) 
            {
                ...
                if( $_obf_0D373E28400B3133012B2218231F340B5C1C2C0C1E3101 == 4 && $i > 4 && $i < 14 ) 
                {
                    $_obf_0D112D233B1F020805310A2D273736173C060210110F22 += 1;
                }
                else if( $_obf_0D373E28400B3133012B2218231F340B5C1C2C0C1E3101 == 4 && $i <= 4 ) 
                {
                    $_obf_0D1B2E1D2408362306342211305C343014232A05252911 += 1;
                }
                else if( $_obf_0D373E28400B3133012B2218231F340B5C1C2C0C1E3101 == 4 && $i == 14 ) 
                {
                    $_obf_0D402A190D1F240B2913211302273E06022932173C1F22 += 1;
                }
            ...
            if( $flush >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 5;
            }
            if( $full >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 8;
            }
            if( $_obf_0D112D233B1F020805310A2D273736173C060210110F22 >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 25;
            }
            if( $_obf_0D1B2E1D2408362306342211305C343014232A05252911 >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 40;
            }
            if( $_obf_0D402A190D1F240B2913211302273E06022932173C1F22 >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 80;
            }
            if( $_obf_0D5B0F052F10120C34130F05300E2E0C190E3D38233F01 >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 100;
            }
            if( $_obf_0D3929343302061507070B045B1B293918105C183F2901 >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 200;
            }
            if( $_obf_0D1E2724162F34090910342C1931383421080F2A182F01 >= 1 ) 
            {
                $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 = 500;
            }
