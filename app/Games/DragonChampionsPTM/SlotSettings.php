    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips0($rIndex, $type)
        {
            ...
            for( $i = 0; $i <= 5; $i++ ) 
            {
                ...
                $_obf_0D04161C1502400B351A02341009220A06092525310532[$i][-1] = $_obf_0D04161C1502400B351A02341009220A06092525310532[$i][$cnt - 1];
                $_obf_0D04161C1502400B351A02341009220A06092525310532[$i][$cnt] = $_obf_0D04161C1502400B351A02341009220A06092525310532[$i][0];
                $_obf_0D5C1E332A07323330351540020105092F333B2A2E2501 = mt_rand(0, $cnt - 3);
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' ) 
            {
                ...
                ] as $index => $reelStrip ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$index + 1] = mt_rand(0, count($this->$reelStrip) - 10);
                    }
                }
            }
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = rand(0, count($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}) - 10);
                    }
                }
            }
            $reel = [
