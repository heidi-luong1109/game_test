...
namespace VanguardLTE\Games\TensOrBetterAM
{
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits, $tipMode)
        {
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032 = [];
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[0] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[1] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[2] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[3] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[4] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[5] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[6] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[7] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[8] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            $_obf_0D2E353B04273607240439263D163F1532262C11351032[9] = [
                'amount' => 0, 
                'cards' => [
                    0, 
                    0, 
            ...
            for( $i = 2; $i <= 14; $i++ ) 
            {
                if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 2 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['amount'] == 1 ) 
                {
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[2]['amount'] = 1;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[2]['cards'][0] = $i;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[2]['cards'][1] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['cards'][0];
                }
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 2 ) 
                {
                ...
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 3 ) 
                {
                ...
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 4 ) 
                {
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[7]['amount'] = 1;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[7]['cards'][0] = $i;
                }
                else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 1] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 2] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 3] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 4] == 1 ) 
                {
                    ...
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][1] = $i + 1;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][2] = $i + 2;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][3] = $i + 3;
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][4] = $i + 4;
                }
            }
            if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['amount'] == 1 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['amount'] == 1 ) 
            {
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[6]['amount'] = 1;
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[6]['cards'][0] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['cards'][0];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[6]['cards'][1] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['cards'][1];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[6]['cards'][2] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['cards'][0];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[6]['cards'][3] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['cards'][1];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[6]['cards'][4] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['cards'][2];
            }
            if( $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[0] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[1] && $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[1] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[2] && $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[2] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[3] && $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[3] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[4] ) 
            {
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['amount'] = 1;
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'][0] = $cards[0];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'][1] = $cards[1];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'][2] = $cards[2];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'][3] = $cards[3];
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'][4] = $cards[4];
            }
            if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['amount'] == 1 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['amount'] == 1 ) 
            {
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['amount'] = 1;
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['cards'] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'];
            }
            if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['amount'] == 1 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['cards'][4] == 14 ) 
            {
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[9]['amount'] = 1;
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[9]['cards'] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'];
            }
            $pay = 0;
            $holds = [
                0, 
            ...
            {
                if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[$i]['amount'] == 1 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[$i]['cards'][0] < 10 && $i == 1 ) 
                {
            ...
            for( $i = 0; $i < 5; $i++ ) 
            {
                if( in_array($cards[$i], $_obf_0D38182B15231B1B243C31152A2A1E040D2B16030B3522) ) 
                {
                    $holds[$i] = $cards[$i];
                }
            }
            if( $tipMode && $pay == 0 ) 
            {
                ...
                for( $i = 2; $i <= 14; $i++ ) 
                {
                    if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 1 && $i >= 10 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['amount'] = 1;
                    ...
                    else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 2 && $i < 10 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['amount'] = 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['cards'][0] = $i;
                    }
                    else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 1] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 2] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 3] == 1 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['amount'] = 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][0] = $i;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][1] = $i + 1;
                    ...
                    else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 1] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 3] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 4] == 1 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['amount'] = 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][0] = $i;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][1] = $i + 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][2] = $i + 3;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][3] = $i + 4;
                    }
                    else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 2] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 3] == 1 && $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i + 4] == 1 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['amount'] = 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][0] = $i;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][1] = $i + 2;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][2] = $i + 3;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[4]['cards'][3] = $i + 4;
                    }
                }
                if( $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[0] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[1] && $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[1] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[2] && $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[2] == $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[3] ) 
                {
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['amount'] = 1;
                    $_obf_0D130D400C252C5B5C080127040C2D281436341E5B3E11 = $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[0];
                    ...
                    {
                        if( $_obf_0D130D400C252C5B5C080127040C2D281436341E5B3E11 == $suits[$_obf_0D04292B192D341239120E11240234133F132832051F01] ) 
                        {
                            $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'][$_obf_0D1D1817065C3B230F143C0F100D350C2A321314193C32] = $cards[$_obf_0D04292B192D341239120E11240234133F132832051F01];
                ...
                {
                    $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['amount'] = 1;
                    $_obf_0D130D400C252C5B5C080127040C2D281436341E5B3E11 = $_obf_0D1D352D03080C0E2540010B161C2C0C03022E18271A11[1];
                    $_obf_0D1D1817065C3B230F143C0F100D350C2A321314193C32 = 0;
                    for( $_obf_0D04292B192D341239120E11240234133F132832051F01 = 0; $_obf_0D04292B192D341239120E11240234133F132832051F01 < 5; $_obf_0D04292B192D341239120E11240234133F132832051F01++ ) 
                    {
                        if( $_obf_0D130D400C252C5B5C080127040C2D281436341E5B3E11 == $suits[$_obf_0D04292B192D341239120E11240234133F132832051F01] ) 
                ...
                for( $i = 0; $i < 5; $i++ ) 
                {
                    if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['amount'] == 1 ) 
                    {
                        if( $_obf_0D130D400C252C5B5C080127040C2D281436341E5B3E11 == $suits[$i] ) 
                        {
                            $holds[$i] = $cards[$i];
                        }
                    }
