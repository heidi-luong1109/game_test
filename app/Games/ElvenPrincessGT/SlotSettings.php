        ...
        public function UpdateJackpots($bet, $jid)
        {
            ...
            for( $jp = 1; $jp <= 2; $jp++ ) 
            {
                if( $this->jpgs[$jp - 1]->balance != '' ) 
                {
                    ...
                    if( $this->jpgs[$jp - 1]->pay_sum <= $this->slotJackpot[$jp - 1] && !$isJackPay && $this->jpgs[$jp - 1]->pay_sum > 0 && $jp == 2 && !$jid ) 
                    {
                        $isJackPay = 1;
                        $isJackId = $jp - 1;
                    ...
                    if( $this->jpgs[$jp - 1]->pay_sum <= $this->slotJackpot[$jp - 1] && !$isJackPay && $this->jpgs[$jp - 1]->pay_sum > 0 && $jp == 1 && $jid ) 
                    {
                        $isJackPay = 1;
                        $isJackId = $jp - 1;
                        $_obf_0D01302528181B3B1B11285C03281F22162B0828071901 = 0;
