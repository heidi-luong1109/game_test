...
namespace VanguardLTE\Games\GrandSpinnSuperpotNET
{
    class SlotSettings
    {
        ...
        {
            $_obf_0D32391619190D5B3233132326101517053B14280D0222 = [];
            $_obf_0D30121D0B3F0606303D3311290425172B282705142E01 = explode('&', $astr);
            foreach( $_obf_0D30121D0B3F0606303D3311290425172B282705142E01 as $_obf_0D0B4036041636292419120B1909361418275B270C0B32 ) 
            {
                $_obf_0D2E301B2A2A100D0D0D0506212839100A0C07081A2901 = explode('=', $_obf_0D0B4036041636292419120B1909361418275B270C0B32);
                $_obf_0D5C1640363002050F030901140F1B3F12250F18230711 = explode('.', $_obf_0D2E301B2A2A100D0D0D0506212839100A0C07081A2901[0]);
                $_obf_0D180C21280308122A2F2D2F21280B1D063605171D0511 =& $_obf_0D32391619190D5B3233132326101517053B14280D0222;
                for( $i = 0; $i < count($_obf_0D5C1640363002050F030901140F1B3F12250F18230711); $i++ ) 
                {
                    if( !isset($_obf_0D180C21280308122A2F2D2F21280B1D063605171D0511[$_obf_0D5C1640363002050F030901140F1B3F12250F18230711[$i]]) ) 
                    {
                        $_obf_0D180C21280308122A2F2D2F21280B1D063605171D0511[$_obf_0D5C1640363002050F030901140F1B3F12250F18230711[$i]] = [];
                    }
                    if( count($_obf_0D5C1640363002050F030901140F1B3F12250F18230711) - 1 == $i ) 
                    {
                        $_obf_0D180C21280308122A2F2D2F21280B1D063605171D0511[$_obf_0D5C1640363002050F030901140F1B3F12250F18230711[$i]] = $_obf_0D2E301B2A2A100D0D0D0506212839100A0C07081A2901[1];
                    }
                    $_obf_0D180C21280308122A2F2D2F21280B1D063605171D0511 =& $_obf_0D180C21280308122A2F2D2F21280B1D063605171D0511[$_obf_0D5C1640363002050F030901140F1B3F12250F18230711[$i]];
                }
            }
            return $_obf_0D32391619190D5B3233132326101517053B14280D0222;
        }
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' ) 
            {
                ...
                ] as $index => $reelStrip ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$index + 1] = mt_rand(3, count($this->$reelStrip) - 3);
                    }
                }
            }
            else
