        ...
        public function GetCombination($cards, $suits, $tipMode)
        {
            ...
            if( $tipMode && $pay == 0 ) 
            {
                ...
                for( $i = 2; $i <= 14; $i++ ) 
                {
                    ...
                    else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 2 && $i < 11 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['amount'] = 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['cards'][0] = $i;
                    }
                ...
                for( $i = 0; $i < 5; $i++ ) 
                {
                    if( $_obf_0D0721112A380C2D1E32291026181E1628235C06333232 == 5 ) 
                    {
                        if( $_obf_0D2D380712112C13290E2E192F1F373B03315B03100432[$cards[$i]] == 0 && in_array($cards[$i], $_obf_0D38182B15231B1B243C31152A2A1E040D2B16030B3522) ) 
                        {
