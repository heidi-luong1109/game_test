            ...
            else
            {
                ...
                if( $bonusType == 1 ) 
                {
                    ...
                    for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                    {
                        ...
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, '7');
                        }
                        else
                        {
