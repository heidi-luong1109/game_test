...
namespace VanguardLTE\Games\JokerSlotKA
{
    class SlotSettings
    {
        ...
        public function GetSymPositions($reels)
        {
            ...
            $_obf_0D2722011B2C34273F323035330D123F2706282E131932 = $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[5] + (8 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[4]) + (64 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[3]) + (512 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[2]) + (4096 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[1]) + (32768 * $_obf_0D085C013D3D5C0503393819382A12393D2A182E341922[0]);
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' ) 
            {
                ...
                ] as $index => $reelStrip ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$index + 1] = mt_rand(0, count($this->$reelStrip) - 5);
                    }
                }
            }
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = rand(0, count($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}) - 5);
                    }
                }
            }
            $reel = [
