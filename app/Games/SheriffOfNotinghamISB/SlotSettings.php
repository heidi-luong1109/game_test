...
namespace VanguardLTE\Games\SheriffOfNotinghamISB
{
    class SlotSettings
    {
        ...
        public function PutBonusToLine($rpID, $pos, $sid)
        {
            ...
            return [
                'rp' => $_obf_0D27292617142A0F131C2A07024013320B242130093D01[0], 
                'reel' => [
                    $rp[$_obf_0D27292617142A0F131C2A07024013320B242130093D01[0] - 1], 
                    $rp[$_obf_0D27292617142A0F131C2A07024013320B242130093D01[0]], 
                    $rp[$_obf_0D27292617142A0F131C2A07024013320B242130093D01[0] + 1], 
                    ''
                ]
        ...
        public function GetRandomScatterPos($rp, $bonusRand)
        {
            if( $bonusRand == 1 ) 
            {
                $_obf_0D0C15133617325B391E0A5C0A110D370A2D2504103601 = [11];
            }
            else
            {
                $_obf_0D0C15133617325B391E0A5C0A110D370A2D2504103601 = [
                    14, 
                    15, 
                    16, 
                    17, 
            ...
            {
                if( in_array($rp[$i], $_obf_0D0C15133617325B391E0A5C0A110D370A2D2504103601) ) 
                {
                    if( $i == 0 ) 
                    {
                        array_push($_obf_0D27292617142A0F131C2A07024013320B242130093D01, $i);
            ...
            else
            {
                ...
                if( $bonusRand == 1 ) 
                {
                    ...
                    for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                    {
                        if( $i == 0 || $i == 2 || $i == 4 ) 
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, $bonusRand);
                        }
                        else
                        {
