...
namespace VanguardLTE\Games\ReelRush2NET
{
    class SlotSettings
    {
        ...
        public function SymbolUpgrade(&$reels, $fCnt)
        {
            ...
            $_obf_0D212C0C2A0F091F3E251C2734172237130524220C0532 = 0;
            $_obf_0D3F3B0B11151D3B2C32310329232829150C093D070D32 = '';
            $_obf_0D1A29071C31062825062A3012030833303F3613241411 = [];
            $_obf_0D01052E0D371113110E291134341C2F0E0214251C2E32 = rand(4, 13);
            $_obf_0D15172A31053328330D275C04282C3B09330928350801 = $_obf_0D01052E0D371113110E291134341C2F0E0214251C2E32 - 1;
            for( $r = 1; $r <= 5; $r++ ) 
            {
                $_obf_0D132B1D2C0F0C3E2F162519391315113F101B36321D11 = $_obf_0D1B1910172D03132D040D301C2A39140C2F0A265C1532[$RespinId][$r - 1];
                foreach( $_obf_0D132B1D2C0F0C3E2F162519391315113F101B36321D11 as $pw => $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 ) 
                {
                    if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $_obf_0D01052E0D371113110E291134341C2F0E0214251C2E32 ) 
                    {
                        $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] = $_obf_0D15172A31053328330D275C04282C3B09330928350801;
                        $_obf_0D1A29071C31062825062A3012030833303F3613241411[] = '%28' . ($r - 1) . '%2C' . $pw . '%29';
                        $_obf_0D212C0C2A0F091F3E251C2734172237130524220C0532++;
                    }
                }
            }
            $_obf_0D3F3B0B11151D3B2C32310329232829150C093D070D32 .= ('&features.i' . $fCnt . '.data.to=SYM' . $_obf_0D15172A31053328330D275C04282C3B09330928350801 . '&features.i' . $fCnt . '.type=SymbolUpgrade&features.i' . $fCnt . '.data.positions=' . implode('%2C', $_obf_0D1A29071C31062825062A3012030833303F3613241411) . '&features.i' . $fCnt . '.data.from=SYM' . $_obf_0D01052E0D371113110E291134341C2F0E0214251C2E32 . '');
            return $_obf_0D3F3B0B11151D3B2C32310329232829150C093D070D32;
        }
        public function RandomWilds(&$reels, $fCnt)
        {
            ...
            for( $_obf_0D2C235B0428363727080401172A3E0B0B1A282B2C1C11 = 1; $_obf_0D2C235B0428363727080401172A3E0B0B1A282B2C1C11 <= 50; $_obf_0D2C235B0428363727080401172A3E0B0B1A282B2C1C11++ ) 
            {
                for( $r = 2; $r <= 5; $r++ ) 
                {
                    $_obf_0D132B1D2C0F0C3E2F162519391315113F101B36321D11 = $_obf_0D1B1910172D03132D040D301C2A39140C2F0A265C1532[$RespinId][$r - 1];
                    ...
                    foreach( $_obf_0D132B1D2C0F0C3E2F162519391315113F101B36321D11 as $pw => $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 ) 
                    {
                        if( rand(1, 5) == 1 && $_obf_0D2D183B0F093112345B390B0E0F19210B3D212D2A1211 < 3 ) 
                        {
                ...
                $_obf_0D3F3B0B11151D3B2C32310329232829150C093D070D32 .= ('&features.i' . $fCnt . '.type=RandomWilds&features.i' . $fCnt . '.data.positions=' . implode('%2C', $_obf_0D1A29071C31062825062A3012030833303F3613241411));
                if( count($_obf_0D1A29071C31062825062A3012030833303F3613241411) > 0 ) 
                {
                    break;
                }
            }
