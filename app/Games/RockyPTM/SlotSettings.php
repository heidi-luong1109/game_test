...
namespace VanguardLTE\Games\RockyPTM
{
    class SlotSettings
    {
        ...
        {
            $_obf_0D30060631373013283D262D0B2505300B03091D221B22 = $rSym;
            if( $rSym == 12 ) 
            {
                $_obf_0D30060631373013283D262D0B2505300B03091D221B22 = 13;
            }
            $_obf_0D27292617142A0F131C2A07024013320B242130093D01 = [];
            for( $i = 0; $i < count($rp); $i++ ) 
            {
                if( $rp[$i] == $rSym || $rp[$i] == $_obf_0D30060631373013283D262D0B2505300B03091D221B22 ) 
                {
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                if( $rSym == 10 ) 
                {
                    ...
                    $_obf_0D151F1B3C2C1B1D1422353B1D2E29315B191C1C011511 = [
                        0, 
                        0, 
                        0, 
                        0, 
                    ...
                    for( $i = 0; $i < $_obf_0D360F0E1F1A363935363D35280B0F3F053D272F233C11; $i++ ) 
                    {
                        $_obf_0D151F1B3C2C1B1D1422353B1D2E29315B191C1C011511[$i] = 1;
                    }
                    shuffle($_obf_0D151F1B3C2C1B1D1422353B1D2E29315B191C1C011511);
                    for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                    {
                        if( $_obf_0D151F1B3C2C1B1D1422353B1D2E29315B191C1C011511[$i] ) 
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, $rSym);
                        }
                        else
                        {
