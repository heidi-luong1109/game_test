...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
        ...
        public function GetFreeSpins($bet, $lines, $countFreeSpins)
        {
            ...
            $freeSeq = [];
            $_obf_0D273B121F5B2832115C35150E06153211370F3B1C2111 = 0;
            for( $_obf_0D25175C1839172A3128125C0A273E5C283217263D1A11 = $countFreeSpins - 1; $_obf_0D25175C1839172A3128125C0A273E5C283217263D1A11 >= 0; $_obf_0D25175C1839172A3128125C0A273E5C283217263D1A11-- ) 
            {
                ...
                if( $i <= 1500 ) 
                {
                    ...
                    for( $line = 1; $line <= $lines; $line++ ) 
                    {
                        ...
                        foreach( $Paytable as $sym => $vl ) 
                        {
                            ...
                            {
                                $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $Paytable[$sym][3] * $bet;
                            ...
                            {
                                $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $Paytable[$sym][4] * $bet;
                                if( $lineWins[$line] < $_obf_0D142C241F1B181D2723252601234035375B141A063811 ) 
                                {
                                    $lineWins[$line] = $_obf_0D142C241F1B181D2723252601234035375B141A063811;
                                    $_obf_0D043B2E133506302A0105273B1C10401E1C3D14100322 = (object)[
                            ...
                            {
                                $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $Paytable[$sym][5] * $bet;
                                if( $lineWins[$line] < $_obf_0D142C241F1B181D2723252601234035375B141A063811 ) 
                                {
                                    $lineWins[$line] = $_obf_0D142C241F1B181D2723252601234035375B141A063811;
                                    $_obf_0D043B2E133506302A0105273B1C10401E1C3D14100322 = (object)[
                ...
                $_obf_0D273B121F5B2832115C35150E06153211370F3B1C2111 += $totalWin;
                $freeSeq[] = '{"FreeGamesCnt":' . $_obf_0D25175C1839172A3128125C0A273E5C283217263D1A11 . ',"LineWins":' . json_encode($_obf_0D2E2C22030E1319363302050D0B2C260304225C1C2311) . ',"Reels":[' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232 . '],"TotalBet":' . ($bet * $lines) . ',"Win":' . $totalWin . '}';
            }
            return [
                $_obf_0D273B121F5B2832115C35150E06153211370F3B1C2111, 
                $freeSeq
            ];
        }
        ...
        public function Bonus($bet, $fuseBet, $rollCnt)
        {
            ...
            for( $i = 0; $i < count($_obf_0D40213D111E3C370802020F340E170F400F0A06163532); $i++ ) 
            {
                $_obf_0D220739241D02120C0F1019291C1F15151A0229060332 = rand(1, 3);
                $_obf_0D362832171714063F2F145B3E251F362B012122193D32 = $_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i] * $bet * $_obf_0D220739241D02120C0F1019291C1F15151A0229060332;
                ...
                {
                    $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332[] = '{"Elem": ' . $bonusSym[$_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i]] . ', "Count": ' . $_obf_0D220739241D02120C0F1019291C1F15151A0229060332 . ',"Coef":' . $_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i] . ',"Win":' . $_obf_0D362832171714063F2F145B3E251F362B012122193D32 . '}';
                }
                else
                {
                    $rollCnt--;
                    $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332[] = 'null';
                    if( $rollCnt < 1 ) 
                    {
                        break;
                    }
        ...
        public function GetRandomScatterPos($rp, $winType, $winType2)
        {
            if( $winType2 ) 
            {
                $_obf_0D29151E1B2C240D1C02303722170B08091C1D09263411 = '9';
            }
            if( $winType ) 
            {
                $_obf_0D29151E1B2C240D1C02303722170B08091C1D09263411 = '0';
            }
            $_obf_0D27292617142A0F131C2A07024013320B242130093D01 = [];
            for( $i = 0; $i < count($rp); $i++ ) 
            {
                if( $rp[$i] == $_obf_0D29151E1B2C240D1C02303722170B08091C1D09263411 ) 
                {
        ...
        public function GetReelStrips($winType, $winType2, $status = '')
        {
            ...
            {
                $reel = new GameReel();
                $_obf_0D2704192E1921372A0E27012935072D34131C34103211 = $reel->reelsStrip;
                foreach( [
                    'reelStrip1', 
                    'reelStrip2', 
                    'reelStrip3', 
            ...
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, $winType, $winType2);
                    }
                    else
                    {
