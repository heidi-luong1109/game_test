    ...
    class SlotSettings
    {
        ...
        public function GetCombination($cards, $suits, $tipMode)
        {
            ...
            if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['amount'] == 1 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[8]['cards'][4] == 14 ) 
            {
                ...
                $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[11]['cards'] = $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[5]['cards'];
            }
            $pay = 0;
            $holds = [
                0, 
            ...
            {
                if( $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[$i]['amount'] == 1 && $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[$i]['cards'][0] < 13 && $i == 1 ) 
                {
            ...
            if( $tipMode && $pay == 0 ) 
            {
                ...
                for( $i = 2; $i <= 14; $i++ ) 
                {
                    if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 1 && $i >= 13 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[1]['amount'] = 1;
                    ...
                    else if( $_obf_0D1E120F042C1634312207100A1D11301C153218072901[$i] == 2 && $i < 13 ) 
                    {
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['amount'] = 1;
                        $_obf_0D37113C25101116100D16243B3C3540112D2B22102732[3]['cards'][0] = $i;
                    }
