    ...
    class SlotSettings
    {
        ...
        public function GetReelStrips($winType, $slotEvent, $ks)
        {
            ...
            if( $slotEvent == 'freespin' ) 
            {
                ...
                $_obf_0D082636082E162709010A0F323432231E2C061E171A11 = $reel->reelsStrip;
                foreach( [
                    'reelStrip1', 
                    'reelStrip2', 
                    'reelStrip3', 
                ...
                ] as $index => $reelStrip ) 
                {
                    if( $index == 0 || $index == 4 ) 
                    {
                        $_obf_0D251A4031061710313030232D1709093F373537373E01 = $_obf_0D082636082E162709010A0F323432231E2C061E171A11['reelStrip' . ($index + 1)];
                    }
                    else
                    {
                        $_obf_0D251A4031061710313030232D1709093F373537373E01 = $_obf_0D2704192E1921372A0E27012935072D34131C34103211['reelStripBonus' . ($index + 1)];
                    }
            ...
            else
            {
                ...
                $_obf_0D101228330A351D340513401F3F211B060F0E1A191822 = [];
                $_obf_0D03370736372D082109063E251D2D11285B382C282D01 = [
                    1, 
                    3
                ];
                shuffle($_obf_0D03370736372D082109063E251D2D11285B382C282D01);
                for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                {
                    if( $_obf_0D03370736372D082109063E251D2D11285B382C282D01[0] == $i ) 
                    {
