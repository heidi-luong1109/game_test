        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601); $i++ ) 
                {
                    if( $i == 0 || $i == 2 || $i == 4 ) 
                    {
                        $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811[$_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]}, $bs[0]);
                    }
                    else
                    {
