    ...
    class SlotSettings
    {
        ...
        public function GetHistory()
        {
            ...
            foreach( $history as $log ) 
            {
                ...
                if( $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'gambleResult' && $_obf_0D1F212D1B1A262C271C2C331110342F041A3014182301->responseEvent != 'bonus' ) 
                {
        ...
        public function SaveLogReport($spinSymbols, $bet, $lines, $win, $slotState)
        {
            ...
            if( $slotState == 'bonus' ) 
            {
                $_obf_0D172C04372D1A2A3C2B33260B34083837222A08343211 = $this->slotId . ' BG';
            }
