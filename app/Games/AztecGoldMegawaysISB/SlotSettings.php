...
namespace VanguardLTE\Games\AztecGoldMegawaysISB
{
    class SlotSettings
    {
        ...
        {
            $_obf_0D3F5B0D230237153D1826081A0C0118191E2E110C3322 = '';
            foreach( [
                'reelStrip' . $pf . '1', 
                'reelStrip' . $pf . '2', 
                'reelStrip' . $pf . '3', 
            ...
            ] as $reelStrip ) 
            {
                if( $this->$reelStrip != '' ) 
                {
                    ...
                    $_obf_0D321E2317401A3D251D231907321D383D2E2D5B1A0311 = dechex(count($data));
                    $_obf_0D3F5B0D230237153D1826081A0C0118191E2E110C3322 .= (strlen($_obf_0D321E2317401A3D251D231907321D383D2E2D5B1A0311) . $_obf_0D321E2317401A3D251D231907321D383D2E2D5B1A0311 . implode('', $data));
                }
            }
            return $_obf_0D3F5B0D230237153D1826081A0C0118191E2E110C3322;
        }
        ...
        {
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722 = [];
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel1'] = [];
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel2'] = [];
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel3'] = [];
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel4'] = [];
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel5'] = [];
            $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel6'] = [];
            for( $r = 1; $r <= 6; $r++ ) 
            {
                for( $p = 6; $p >= 0; $p-- ) 
                {
                    if( $reels['reel' . $r][$p] != -2 ) 
                    {
                        array_unshift($_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel' . $r], $reels['reel' . $r][$p]);
                    }
                }
            }
            for( $r = 1; $r <= 6; $r++ ) 
            {
                for( $p = count($_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel' . $r]) + 1; $p <= 7; $p++ ) 
                {
                    array_unshift($_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722['reel' . $r], rand(1, 10));
                }
            }
            return $_obf_0D1D0613132C1D050C2528310F3E2C1130222E34223722;
        }
        public function GetReelsWin($reels, $lines, $betline, $betlineRaw, $linesId, $cWins, $spinCnt)
        {
            ...
            {
                $_obf_0D011C142C3C37263F351C4012170A074027083F321132 = (string)$this->SymbolGame[$j];
                ...
                else
                {
                    ...
                    if( $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2] > 0 ) 
                    {
                        $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 = $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] * $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2];
                        $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][2] * $betline * $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 * $bonusMpl;
                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                        {
                            ...
                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "ways": "' . $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 . '", "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "multiplier": "1", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "pos": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "hl": "' . implode('', $_obf_0D1D15220D1325253F2219091A382D241B14302A071A22) . '", "dir": "0" }';
                        }
                    }
                    if( $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[3] > 0 ) 
                    {
                        ...
                        $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][3] * $betline * $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 * $bonusMpl;
                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                        {
                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "ways": "' . $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 . '", "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "multiplier": "1", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "pos": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "hl": "' . implode('', $_obf_0D1D15220D1325253F2219091A382D241B14302A071A22) . '", "dir": "0" }';
                    ...
                    if( $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[3] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[4] > 0 ) 
                    {
                        ...
                        $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][4] * $betline * $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 * $bonusMpl;
                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                        {
                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "ways": "' . $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 . '", "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "multiplier": "1", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "pos": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "hl": "' . implode('', $_obf_0D1D15220D1325253F2219091A382D241B14302A071A22) . '", "dir": "0" }';
                    ...
                    if( $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[3] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[4] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[5] > 0 ) 
                    {
                        ...
                        $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][5] * $betline * $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 * $bonusMpl;
                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                        {
                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{ "ways": "' . $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 . '", "value": "' . round(($cWins[$k] * 100) / $betlineRaw) . '", "valueMoney": "' . ($cWins[$k] * 100) . '", "multiplier": "1", "symbolId": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "pos": "' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132 . '", "hl": "' . implode('', $_obf_0D1D15220D1325253F2219091A382D241B14302A071A22) . '", "dir": "0" }';
                    ...
                    if( $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[3] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[4] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[5] > 0 && $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[6] > 0 ) 
                    {
                        $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 = $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[1] * $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[2] * $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[3] * $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[4] * $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[5] * $_obf_0D400C2B0C4040290529333B280406045B3F34153B1022[6];
                        $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $this->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][6] * $betline * $_obf_0D011B072F07402E1E5B23261A11211F21101F381A2C32 * $bonusMpl;
                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                        {
                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            if( $winType != 'bonus' ) 
            {
                ...
                ] as $index => $reelStrip ) 
                {
                    ...
                    {
                        $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$index + 1] = mt_rand(0, count($this->$reelStrip) - 6);
                    }
                }
            }
            else
            ...
            foreach( $_obf_0D101228330A351D340513401F3F211B060F0E1A191822 as $index => $value ) 
            {
                ...
                $key[-1] = $key[$cnt - 1];
                $key[$cnt] = $key[0];
                $_obf_0D3C153E1E0E2D1422250D0E133C16062C361A0A252601 = rand(3, 7);
                $ways = $ways * $_obf_0D3C153E1E0E2D1422250D0E133C16062C361A0A252601;
                for( $pw = 0; $pw < 7; $pw++ ) 
                {
                    if( $pw < $_obf_0D3C153E1E0E2D1422250D0E133C16062C361A0A252601 ) 
                    {
