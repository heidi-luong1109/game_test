...
namespace VanguardLTE\Games\LadyJesterGTM
{
    class SlotSettings
    {
        ...
        {
            $totalWin = 0;
            $_obf_0D34381D1004370423192D0B0729162C022F190F261732 = 0;
            $_obf_0D2A0810172A3C30195B0F10101D312724051F35030C22 = true;
            for( $_obf_0D190B192D351B14365C1F3235060F172B3C291D3C3411 = 0; $_obf_0D190B192D351B14365C1F3235060F172B3C291D3C3411 <= 100; $_obf_0D190B192D351B14365C1F3235060F172B3C291D3C3411++ ) 
            {
                $cWins = [
                    0, 
                    0, 
                ...
                for( $r = 1; $r <= 5; $r++ ) 
                {
                    $_obf_0D3E320D3D1C311E3905260D332515021E03212D2A2F22 = false;
                    ...
                    {
                        if( $cReels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == 'P_1' ) 
                        {
                            $_obf_0D3E320D3D1C311E3905260D332515021E03212D2A2F22 = true;
                            break;
                        }
                    }
                    if( $_obf_0D3E320D3D1C311E3905260D332515021E03212D2A2F22 ) 
                    {
                        for( $_obf_0D31403C0837332A1A1711312A3415151610280F122122 = 0; $_obf_0D31403C0837332A1A1711312A3415151610280F122122 <= 3; $_obf_0D31403C0837332A1A1711312A3415151610280F122122++ ) 
                        {
                            $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] = 'P_1';
                        }
                    }
                }
                for( $k = 0; $k < $lines; $k++ ) 
                {
                    ...
                    {
                        $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 = $this->SymbolGame[$j];
                        if( $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == $scatter || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_1' || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_2' || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_3' || $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == 'P_1_4' ) 
                        {
                        }
                        else
                        {
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D365B172533170712222423300A1B092C161521071B32 = $this->Paytable[$_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][1] * $bet * $mpl;
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D365B172533170712222423300A1B092C161521071B32 = $this->Paytable[$_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][2] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                {
                                    $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                }
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D365B172533170712222423300A1B092C161521071B32 = $this->Paytable[$_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][3] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                {
                                    $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                }
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D365B172533170712222423300A1B092C161521071B32 = $this->Paytable[$_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][4] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                {
                                    $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                }
                            ...
                            {
                                $mpl = 1;
                                $_obf_0D365B172533170712222423300A1B092C161521071B32 = $this->Paytable[$_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][5] * $bet * $mpl;
                                if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                {
                                    $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                }
                ...
                if( $totalWin < $_obf_0D34381D1004370423192D0B0729162C022F190F261732 ) 
                {
                    $_obf_0D34381D1004370423192D0B0729162C022F190F261732 = $totalWin;
                }
                if( $_obf_0D2A0810172A3C30195B0F10101D312724051F35030C22 ) 
                {
                    $_obf_0D2A0810172A3C30195B0F10101D312724051F35030C22 = false;
                    $_obf_0D34381D1004370423192D0B0729162C022F190F261732 = $totalWin;
                }
            }
            return $_obf_0D34381D1004370423192D0B0729162C022F190F261732;
        }
        ...
        public function UpdateJackpots($bet, $isJack, $isJack2)
        {
            ...
            for( $jp = 1; $jp <= 1; $jp++ ) 
            {
                if( $this->jpgs[$jp - 1]->balance != '' ) 
                {
                    ...
                    {
                        $_obf_0D0F3334103F22035B2A2D1E1F30231906330229183232[$jp - 1] = $count_balance / 100 * $this->slotJackPercent[$jp - 1] + $this->slotJackpot[$jp - 1];
                    }
                    else if( !$isJack ) 
                    {
                    ...
                    if( $this->jpgs[$jp - 1]->pay_sum <= $this->slotJackpot[$jp - 1] && !$isJackPay && $this->jpgs[$jp - 1]->pay_sum > 0 && $isJack2 && $isJack ) 
                    {
                        $isJackPay = 0;
                        $isJackId = $jp - 1;
                        $this->Jackpots['jackPay'] = $_obf_0D0F3334103F22035B2A2D1E1F30231906330229183232[$jp - 1];
        ...
        public function PutBonusToLine($rpID, $pos, $sid)
        {
            ...
            return [
                'rp' => $_obf_0D341A3417182E3C3706123C162827152E2C0E13102632[0], 
                'reel' => [
                    $rp[$_obf_0D341A3417182E3C3706123C162827152E2C0E13102632[0]], 
                    $rp[$_obf_0D341A3417182E3C3706123C162827152E2C0E13102632[0] + 1], 
                    $rp[$_obf_0D341A3417182E3C3706123C162827152E2C0E13102632[0] + 2], 
                    ''
                ]
            ];
        }
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if( $winType != 'bonus' ) 
            {
                ...
                ] as $index => $reelStrip ) 
                {
                    ...
                    {
                        $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811[$index + 1] = mt_rand(0, count($this->$reelStrip) - 4);
                    }
                }
            }
            else
            {
                ...
                for( $i = 0; $i < count($_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601); $i++ ) 
                {
                    ...
                    {
                        $_obf_0D1F1D041B280532291A2C2B223C14135C2427303D0811[$_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]] = rand(0, count($this->{'reelStrip' . $_obf_0D1402241D140F0A0D2414233E341B2C0A0A242C052601[$i]}) - 4);
                    }
                }
            }
            $reel = [
