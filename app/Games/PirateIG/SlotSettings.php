...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
        ...
        public function Bonus2($bet, $fuseBet)
        {
            ...
            $_obf_0D5B263F3E2D3E1D151534233C2B0B2203010128292A22 = [];
            $_obf_0D5B263F3E2D3E1D151534233C2B0B2203010128292A22[1] = 1;
            $_obf_0D5B263F3E2D3E1D151534233C2B0B2203010128292A22[3] = 2;
            $_obf_0D5B263F3E2D3E1D151534233C2B0B2203010128292A22[10] = 3;
            $_obf_0D5B263F3E2D3E1D151534233C2B0B2203010128292A22[20] = 4;
            $_obf_0D0C212617151A0F1C3F17340110401040362617122511 = [
                0, 
                1, 
                1, 
                1, 
            ...
            $_obf_0D0F32043439283D0E402203360A2223213928182C1422 = 0;
            ...
            for( $i = 0; $i < 10; $i++ ) 
            {
                $_obf_0D37093D123E5C15013E182A3C240D3434031933330901 = rand(1, 6);
                $_obf_0D0F32043439283D0E402203360A2223213928182C1422 += $_obf_0D37093D123E5C15013E182A3C240D3434031933330901;
                if( $_obf_0D0F32043439283D0E402203360A2223213928182C1422 > 10 ) 
                {
                    $_obf_0D0F32043439283D0E402203360A2223213928182C1422 = $_obf_0D0F32043439283D0E402203360A2223213928182C1422 - 10;
                }
                $_obf_0D362832171714063F2F145B3E251F362B012122193D32 = $_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i] * $bet * $_obf_0D0C212617151A0F1C3F17340110401040362617122511[$_obf_0D0F32043439283D0E402203360A2223213928182C1422];
                $_obf_0D0C212617151A0F1C3F17340110401040362617122511[$_obf_0D0F32043439283D0E402203360A2223213928182C1422] = 0;
                $_obf_0D3C162D36343E2D2D02371D080A2219080E0C26210232 += $_obf_0D362832171714063F2F145B3E251F362B012122193D32;
                if( $_obf_0D362832171714063F2F145B3E251F362B012122193D32 > 0 ) 
                {
                    $_obf_0D1A3913122417082A3E2E165B2D15122F2D2238310601 = ',"Gem":' . $_obf_0D5B263F3E2D3E1D151534233C2B0B2203010128292A22[$_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i]];
                }
                else
                {
                    $_obf_0D1A3913122417082A3E2E165B2D15122F2D2238310601 = '';
                }
                $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332[] = '{"Coef":' . $_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i] . ',"Win":' . $_obf_0D362832171714063F2F145B3E251F362B012122193D32 . ',"Die":' . $_obf_0D37093D123E5C15013E182A3C240D3434031933330901 . '' . $_obf_0D1A3913122417082A3E2E165B2D15122F2D2238310601 . '}';
                if( $_obf_0D362832171714063F2F145B3E251F362B012122193D32 == 0 ) 
                {
                    break;
                }
            }
            $_obf_0D2D2F1A5B1A3E312F26112C19113D0A231919045C2732 = '"Bonus1Wins":[[' . implode(',', $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332) . ']],';
            return [
        ...
        public function Bonus($bet, $fuseBet, $bSymCnt)
        {
            ...
            for( $i = 0; $i < $bSymCnt; $i++ ) 
            {
                ...
                $_obf_0D3C162D36343E2D2D02371D080A2219080E0C26210232 += $_obf_0D362832171714063F2F145B3E251F362B012122193D32;
                $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332[] = '{"Coef":' . $_obf_0D40213D111E3C370802020F340E170F400F0A06163532[$i] . ',"Win":' . $_obf_0D362832171714063F2F145B3E251F362B012122193D32 . ',"Die":0}';
                if( $_obf_0D362832171714063F2F145B3E251F362B012122193D32 == 0 ) 
                {
                    break;
                }
            }
            $_obf_0D2D2F1A5B1A3E312F26112C19113D0A231919045C2732 = '"Bonus2Wins":[' . implode(',', $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332) . '],';
            return [
                'win' => $_obf_0D3C162D36343E2D2D02371D080A2219080E0C26210232, 
                'info' => $_obf_0D2D2F1A5B1A3E312F26112C19113D0A231919045C2732
            ];
        ...
        public function GetRandomScatterPos($rp)
        {
            ...
            {
                $_obf_0D1E1E2D5C173410021C5C5C21140B2C04313B11280F32 = 0;
            }
            else
            {
                $_obf_0D1E1E2D5C173410021C5C5C21140B2C04313B11280F32 = 9;
            }
            $_obf_0D27292617142A0F131C2A07024013320B242130093D01 = [];
            for( $i = 0; $i < count($rp); $i++ ) 
            {
                if( $rp[$i] == $_obf_0D1E1E2D5C173410021C5C5C21140B2C04313B11280F32 ) 
                {
        ...
        public function GetReelStrips($winType, $tmpBsCnt = 3)
        {
            ...
            else
            {
                ...
                $_obf_0D360F0E1F1A363935363D35280B0F3F053D272F233C11 = $tmpBsCnt;
