            ...
            ] as $reelStrip ) 
            {
                if( $this->$reelStrip != '' ) 
                {
                    ...
                    foreach( $data as &$item ) 
                    {
                        ...
                        $item = trim($item);
                        $_obf_0D403B13193D352B0533013B113F0A110A380134253232 = strlen(dechex($item));
                        if( $_obf_0D403B13193D352B0533013B113F0A110A380134253232 <= 1 ) 
                        {
                            $_obf_0D403B13193D352B0533013B113F0A110A380134253232 = '0';
                        }
                        else
                        {
                            $_obf_0D403B13193D352B0533013B113F0A110A380134253232 = '';
                        }
                        $item = $_obf_0D403B13193D352B0533013B113F0A110A380134253232 . dechex($item);
                    }
