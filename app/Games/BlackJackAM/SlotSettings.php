    ...
    class SlotSettings
    {
        ...
        public function GetScore(&$box)
        {
            ...
            for( $i = 0; $i < count($crds); $i++ ) 
            {
                if( $crds[$i] != '63' ) 
                {
                    $_obf_0D191C3C30335B14232D3B27091002083B03223F082A32 = explode('_', $crds[$i]);
                    $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32 = (int)$_obf_0D191C3C30335B14232D3B27091002083B03223F082A32[1];
                    if( $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32 <= 10 ) 
                    {
                        $box['mainScore'] += $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32;
                        $box['altScore'] += $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32;
                    }
                    else if( $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32 <= 13 ) 
                    {
                        $box['mainScore'] += 10;
                        $box['altScore'] += 10;
                    }
