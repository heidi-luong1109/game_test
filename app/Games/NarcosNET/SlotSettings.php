...
namespace VanguardLTE\Games\NarcosNET
{
    class SlotSettings
    {
        ...
        public function GetCluster($reels)
        {
            for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 2; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
            {
                for( $r = 1; $r <= 5; $r++ ) 
                {
                    ...
                    {
                        if( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 == 0 && $r == 1 ) 
                        {
                            $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] = '2c';
                        }
                        else
                        {
                            if( isset($reels['reel' . ($r - 1)][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32]) && $reels['reel' . ($r - 1)][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == '2c' ) 
                            {
                                $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] = '2c';
                            }
                            if( isset($reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 - 1]) && $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 - 1] == '2c' ) 
                            {
                                $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] = '2c';
                            }
                        }
        ...
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            {
                $_obf_0D5C0B0F280B153E0604100A1F245C2925211E075B0F32 = rand(1, 2);
                if( $_obf_0D5C0B0F280B153E0604100A1F245C2925211E075B0F32 == 1 ) 
                {
                    ...
                    for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                    {
                        if( $i == 0 || $i == 2 || $i == 4 ) 
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, '0');
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    $_obf_0D1110083E2711381A5C402B2E2D34281C0B2A0F2D1D22 = rand(3, 5);
                    for( $i = 0; $i < count($_obf_0D340F1A341017095B37324005163D02312C041E262632); $i++ ) 
                    {
                        if( $i < $_obf_0D1110083E2711381A5C402B2E2D34281C0B2A0F2D1D22 ) 
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = $this->GetRandomScatterPos($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}, '2');
                        }
                        else
                        {
                            $_obf_0D101228330A351D340513401F3F211B060F0E1A191822[$_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]] = rand(0, count($this->{'reelStrip' . $_obf_0D340F1A341017095B37324005163D02312C041E262632[$i]}) - 3);
