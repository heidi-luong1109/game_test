...
<div class="col-md-6">
    <div class="form-group">
        <label><?php echo app('translator')->get('app.icon'); ?></label>
        <input type="text" class="form-control" name="icon" placeholder="<?php echo app('translator')->get('app.icon'); ?>" value="<?php echo e($edit ? $category->icon : ''); ?>">
    </div>
</div><?php /**PATH /home/cc.heidi.net.au/public_html/resources/views/backend/categories/partials/base.blade.php ENDPATH**/ ?>