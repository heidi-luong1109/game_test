...
<img src="prva.jpg" style="position: absolute;
  ...
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo e(route('frontend.auth.login')); ?>"><span class="logo-lg"><b><br><br><br></b> <small></small></span></a>
    </div>
...
<span  style="color: #fff;
    ...
    font-weight: 700;
        ...
        <div class="form-group has-feedback">
          <input type="text" name="username" id="username" class="form-control" placeholder="<?php echo app('translator')->get(''); ?>">
...
<span  style="color: #fff;
    ...
    font-weight: 700;
        ...
        <div class="form-group has-feedback">
          <input type="password" name="password" id="password" class="form-control" placeholder="<?php echo app('translator')->get(''); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Task\Casino-Engine\resources\views/frontend/Default/auth/login.blade.php ENDPATH**/ ?>