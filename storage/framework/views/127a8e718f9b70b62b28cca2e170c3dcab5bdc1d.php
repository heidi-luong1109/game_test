				...
				<div class="col-sm-4">
					...
					<div class="btn-group-vertical w-100 payment-button-group">
						<button type="button" class="btn btn-outline-success mb-1 rounded-0">
                            <img src="<?php echo e(asset('frontend/Default/img/interac-payment-icon.jpg')); ?>" alt="">
                        </button>
						<button type="button" class="btn btn-outline-success rounded-0">
                            <img src="<?php echo e(asset('frontend/Default/img/bitcoin-payment-icon.png')); ?>" alt="">
                        </button>
					</div>
				</div>
				<div class="col-sm-8">
...
<?php /**PATH /home/cc.heidi.net.au/public_html/resources/views/component/frontend/layout/deposit.blade.php ENDPATH**/ ?>