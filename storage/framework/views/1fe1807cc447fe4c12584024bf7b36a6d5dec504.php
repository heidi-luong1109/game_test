                                    ...
                                    <?php $__currentLoopData = $open_shift; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num=>$stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($stat->balance_out); ?></td>
                                                <?php endif; ?>
                                                    <td><?php echo e(number_format ($stat->balance + $stat->balance_in - $stat->balance_out, 2, ".", "")); ?></td>
                                                <?php if (\Auth::user()->hasPermission('games.in_out')) : ?>
                                                <?php
                                                $banks = !$stat->end_date ? $stat->banks() : $stat->last_banks;
                                            ?>
                                            <td><?php echo e(number_format ($banks, 2, ".", "")); ?></td>
                                                <?php endif; ?>
                                            <td>
                                            ...
                                            <?php if(auth()->user()->hasRole('admin')): ?>
                                                <td><?php echo e(number_format ($stat->profit(), 2, ".", "")); ?></td>
                                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Task\Casino-Engine\resources\views/backend/dashboard/admin.blade.php ENDPATH**/ ?>